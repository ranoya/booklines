...
gsdata($_GET["file"], function (d) {
  ...
  if (
    localStorage.getItem("livroJSD_SE") == "" ||
    typeof localStorage.getItem("livroJSD_SE") == "undefined"
  ) {
...
function draw() {
  ...
  document.getElementById("timeline").innerHTML = `
    <iframe frameborder="0" style="width: 100%; height: 100%;" src='https://omnicode.vercel.app/clr/?buffer=livroJSD_SE&lang=p5&pborder=00000044&bordercolor=${bgc}&bgcolor=${bgc}&bordercolor=${bgc}&gutcolor=${bgc}&'></iframe>`;
});
